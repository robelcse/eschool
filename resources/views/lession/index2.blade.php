                    ...
                    <div class="eschool-quiz" id="{{ $unit->unit_id }}">
                        ...
                        <div class="d-none" id="startQuizeSection{{ $unit->unit_id }}">
                            ...
                            <div class="text-center mb-4">
                                <button class="startQuize btn btn-primary" data-id="{{ $unit->unit_id }}" class="btn btn-primary eschool-large-btn" type="button">Start Quize</button>
                            </div>
                        ...
                        <div class="d-none quiz-body" id="quizBody{{$unit->unit_id}}">
                            ...
                            <ul class="quiz-questions">
                                <li class="mb-5">
                                    <div class="quiz-area">
                                        ...
                                        <div class="quiz-ques-title mb-3">{{ $single_question->id }}.
                                        ...
                                        <div class="quiz-options">
                                            <div class="radio radio-primary mb-2">
                                                ...
                                                <input type="radio" id="{{ $option }}" name="an[{{ $single_question->id }}]" value="{{ $option == $single_question->answer ? 1: 0 }}" class="question_ans" data-subject={{ $single_question->subject_id }} data-chapter={{ $single_question->chapter_id }} data-unit={{ $single_question->unit_id }} data-question={{ $single_question->id }} data-ans="{{ $option }}" data-user={{ $single_question->user_id }}>
                            ...
                            <div class="text-center mb-4">
                                <button class="btn btn-primary eschool-large-btn completeQuize" type="button" data-id="{{ $unit->unit_id }}">Complete Quiz</button>
                            </div>
                                ...
                                <div class="collapse" id="collapseicon{{ $unit->unit_id }}" data-bs-parent="#accordionoc">
                                    <div class="card-body">
                                        <ul class="course-each-module">
                                            ...
                                            <li class="lession-quiz eschool-quiz-item" id="{{ $unit->unit_id }}" data-quiz-id="124" data-id="{{ $unit->unit_id }}">
